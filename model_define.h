...
const REAL IF_GRID_SPACING = 950.0; // micrometers 
...
const REAL A_MCARRIER_DENSITY_PER_UB =  10 / (32.0 *32.0 * 32.0 ) ;  // 2000 //0.02 ; // 0.1
const REAL A_CELL_DENSITY_PER_UB_AREA = 10/ ( 8.0 * 64 ) ; // 
...
// cell growth
const REAL DOUBLING_TIME = 1000 ;   //BASELINE_TIME_STEP_DURATION * 100000 ; // I also used 100000
...
const REAL MECH_STRESS_TRESHOLD_DEATH = 5e-7 ;  //  2.5e-7 ;//5e-7 ;
const REAL TIME_TO_DEATH = 0.2 *  DOUBLING_TIME   ;   
